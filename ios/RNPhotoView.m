...
- (void)setMaxMinZoomScalesForCurrentBounds {
    ...
    CGSize boundsSize = self.bounds.size;
    CGSize imageSize = _photoImageView.image.size;
    if (boundsSize.height == 0.0 || boundsSize.width == 0.0){
       boundsSize.height = [[UIScreen mainScreen] bounds].size.height;
       boundsSize.width = [[UIScreen mainScreen] bounds].size.width;
    }
